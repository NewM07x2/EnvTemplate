<template>
  <div>
    <h1>Vue + GraphQL + Prisma テンプレート</h1>
    
    <div class="card">
      <h2>🎯 このテンプレートについて</h2>
      <p>
        このテンプレートは、Vue 3 + TypeScript + Docker + GraphQL (urql) + Prisma (SSR)
        の環境を提供します。
      </p>
    </div>
    ...
    <div class="card">
      <h2>📦 主な技術スタック</h2>
      <ul>
        <li><strong>Vue 3</strong> - プログレッシブJavaScriptフレームワーク</li>
        ...
        <li><strong>Pinia</strong> - 状態管理</li>
        <li><strong>Vue Router</strong> - ルーティング</li>
        <li><strong>PostgreSQL</strong> - データベース</li>
        <li><strong>Docker</strong> - コンテナ化</li>
        <li><strong>Vitest</strong> - テストフレームワーク</li>
      </ul>
    </div>
